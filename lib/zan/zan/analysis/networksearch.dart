...
class _FragmentState extends State<NetworkSuspect>  with TickerProviderStateMixin {
            ...
            children: <Widget>[
              ...
              Column(
                children: <Widget>[
                 ...
                 Navigator.push(context, MaterialPageRoute(builder: (context) => TabScreenArrest4Suspect2(ItemsSuspect: widget.ItemsSuspect)),);
                  },
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: <Widget>[
                        ...
                        Text(widget.ItemsSuspect.TITLE_SHORT_NAME_TH+
    ...
    return new WillPopScope(
      ...
      child: Scaffold(
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            title: new Text("วิเคราะห์ข้อมูลผู้ต้องหา",
