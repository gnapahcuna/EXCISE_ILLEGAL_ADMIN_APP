...
import 'package:prototype_app_pang/zan/zan/search/result/Search_result_Person.dart';
class NetworkMainScreenFragmentSearch extends StatefulWidget {
  ...
  @override
  NetworkMainScreenFragmentSearchState createState() => new NetworkMainScreenFragmentSearchState();
}
class NetworkMainScreenFragmentSearchState extends State<NetworkMainScreenFragmentSearch> {
  ...
  _navigateSearch(BuildContext mContext) async {
    ...
    if(itemSearch.length>0){
      final result = await Navigator.push(
        mContext,
        MaterialPageRoute(builder: (context) => NetworkMainScreenFragmentSearchResult(
