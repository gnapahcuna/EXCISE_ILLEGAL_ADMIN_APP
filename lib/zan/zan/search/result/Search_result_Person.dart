...
import 'package:prototype_app_pang/zan/zan/analysis/networksearch.dart';
  ...
  _navigatePreview(BuildContext context,Map map) async {
    ...
    if(Success){
      final result = await Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => NetworkSuspect(ItemsSuspect: ItemsPreviewIndicmentDetail,)),
      );
      print(result);
      /*_itemsData=result;
      Navigator.pop(context,_itemsData);*/
