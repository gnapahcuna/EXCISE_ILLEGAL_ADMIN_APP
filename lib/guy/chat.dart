...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle textLabelStyle =
        TextStyle(fontSize: 16.0, fontFamily: FontStyles().FontFamily,color: Colors.white);
    TextStyle textLabelSubStyle =
    TextStyle(fontSize: 14.0, fontFamily: FontStyles().FontFamily,color: Colors.grey[400]);
    TextStyle textLabelHintStyle =
    TextStyle(fontSize: 16.0, fontFamily: FontStyles().FontFamily,color: Colors.grey[400]);
    TextStyle textLabelDateStyle =
    TextStyle(fontSize: 16.0, fontFamily: FontStyles().FontFamily,color: Colors.grey[700]);
    ...
    var textInput = Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          IconButton(
              icon: Icon(Icons.camera_alt,color: Color(0xff549ee8),size: 32.0,),
              onPressed: () {
                ...
                var messagebody = Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(_convertTime(_messages[index].time_stamp),style: textLabelSubStyle,),
                    )
                  ],
                );
                  ...
                  return Row(
                    ...
                    children: <Widget>[
                     Padding(
                       ...
                       child:  Text(_convertDate(_messages[index].time_stamp),style: textLabelDateStyle,),
                     )
                    ],
                  );
                }
