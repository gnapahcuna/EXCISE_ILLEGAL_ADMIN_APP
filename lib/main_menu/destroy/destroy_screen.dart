...
class DestroyMainScreenFragment extends StatefulWidget {
  ItemsDestroyMain ItemsdestroyMain;
  bool IsUpdate;
  bool IsPreview;
  bool IsCreate;
...
class _FragmentState extends State<DestroyMainScreenFragment>  with TickerProviderStateMixin {
  ...
  void _setDataSaved() {
    ...
    if (choices.length == 2) {
      ...
      //เพิ่ม item forms
      itemsFormsTab.add(
          new ItemsDestroyForms("บัญชีรายการทำลายของกลาง"));
    }
    tabController =
  ...
  void onSaved() async {
    ...
    setState(() {
      ...
      itemMain = new ItemsDestroyMain(approve, destroy, true);
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> rowContents = <Widget>[
      ...
      Expanded(
          child: Center(child: Text("ทำลายของกลาง", style: appBarStyle),
          )),
      new SizedBox(
          width: width / 4,
          child: new Row(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      padding: paddingLabel,
                      child: Text(
                        "เลขที่ทำลาย", style: textLabelStyle,),
                    ),
                    Container(
                      padding: paddingInputBox,
                      child: Text(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Text(
                            "วันที่ทำลาย", style: textLabelStyle,),
                          Text("*", style: textStyleStar,),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Text(
                            "ประธานทำลายของกลาง", style: textLabelStyle,),
                          Text("*", style: textStyleStar,),
                        ],
                      ),
                    ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Container(
                        padding: paddingLabel,
                        child: Text("เลขที่ทำลาย", style: textLabelStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
                        child: Text(
                      ...
                      Container(
                        padding: paddingLabel,
                        child: Text("ประธานทำลายของกลาง", style: textLabelStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
                        child: Text(
