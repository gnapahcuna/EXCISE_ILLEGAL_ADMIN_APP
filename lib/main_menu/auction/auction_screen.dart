...
class AuctionMainScreenFragment extends StatefulWidget {
  ItemsAuctionMain ItemsauctionMain;
  bool IsUpdate;
  bool IsPreview;
  bool IsCreate;
  AuctionMainScreenFragment({
    Key key,
    @required this.ItemsauctionMain,
...
class _FragmentState extends State<AuctionMainScreenFragment>  with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    itemMain = widget.ItemsauctionMain;
    if (widget.IsPreview) {
  ...
  void _setDataSaved() {
    ...
    if (choices.length == 2) {
      ...
      //เพิ่ม item forms
      itemsFormsTab.add(
          new ItemsDestroyForms("บัญชีรายการขายของกลาง"));
    }
    tabController =
  ...
  void onSaved() async {
    ...
    setState(() {
      ...
      ItemsApprove approve = new ItemsApprove(
          editApproveNumber.text,
          editOfferDate.text,
          editOfferTime.text,
          editPersonOffer.text,
          editOfferDepartment.text,
          editPersonConsider.text,
          editConsiderDepartment.text,
          editConsiderDate.text,
          editConsiderTime.text,
          editStock.text);
      ItemsDestroy destroy = ItemsDestroy(
          editDesployNumber.text,
          editDesployDate.text,
          editDesployTime.text,
          editDesployPerson.text,
          editDesployDepartment.text,
          itemEvidence
      );
      itemMain = new ItemsAuctionMain(approve, destroy, true);
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> rowContents = <Widget>[
      ...
      Expanded(
          child: Center(child: Text("ขายทอดตลาด", style: appBarStyle),
          )),
      new SizedBox(
          width: width / 4,
          child: new Row(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Row(
                              children: <Widget>[
                                Text("คลังจัดเก็บ", style: textLabelStyle,),
                                Text("*", style: textStyleStar,),
                              ],
                            ),
                          ),
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Container(
                        padding: paddingLabel,
                        child: Text(
                          "เลขที่หนังสืออนุมัติ", style: textLabelStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
                      ...
                      Padding(
                        padding: paddingInputBox,
                        child: Text(itemMain.Approves.PersonOffer,
                          style: textInputStyle,),
                      ),
                      Container(
                        padding: paddingLabel,
                      ...
                      Padding(
                        padding: paddingInputBox,
                        child: Text(itemMain.Approves.OfferDepartment,
                          style: textInputStyle,),
                      ),
                      Container(
                        padding: paddingLabel,
...
//************************end_tab_1*******************************
  ...
  navigateDeliveredBook(BuildContext context) async {
    final result = await Navigator.push(
      ...
      MaterialPageRoute(
          builder: (context) =>
              AuctionBookSearchScreenFragment(
              )),
    );
  ...
  Widget _buildContent_tab_2() {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      padding: paddingLabel,
                      child: Text(
                        "เลขที่ขาย", style: textLabelStyle,),
                    ),
                    Container(
                      padding: paddingInputBox,
                      child: Text(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Text(
                            "วันที่จัดเก็บ", style: textLabelStyle,),
                          Text("*", style: textStyleStar,),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Text(
                            "ประธานขายของกลาง", style: textLabelStyle,),
                          Text("*", style: textStyleStar,),
                        ],
                      ),
                    ),
    ...
    Widget _buildContent_saved(BuildContext context) {
      ...
      Widget _buildExpandableContent(int index) {
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    padding: paddingInputBox,
                    child: Text(
                      itemMain.Destroys.Evidences[index].ProductGroup + ' / ' +
                          itemMain.Destroys.Evidences[index].MainBrand, style: textInputStyle,),
                  ),
                  SingleChildScrollView(
                    scrollDirection: Axis.horizontal,
                    child: Row(
        ...
        return ExpandableNotifier(
          controller: itemMain.Destroys.Evidences[index].EvidenceDetailController
              .expController,
          child: Stack(
            children: <Widget>[
              Expandable(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Container(
                        padding: paddingLabel,
                        child: Text("เลขที่ขาย", style: textLabelStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
                        child: Text(
                          itemMain.Destroys.DestroyNumber,
                          style: textInputStyle,),
                      ),
                      Container(
                        padding: paddingLabel,
                        child: Text("วันที่จัดเก็บ", style: textLabelStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
                        child: Text(
                          itemMain.Destroys.DestroyDate+" "+itemMain.Destroys.DestroyTime,
                          style: textInputStyle,),
                      ),
                      Container(
                        padding: paddingLabel,
                        child: Text("ประธานขายของกลาง", style: textLabelStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
                        child: Text(
                          itemMain.Destroys.DestroyPerson, style: textInputStyle,),
                      ),
                      Container(
                        padding: paddingLabel,
                        child: Text("หน่วยงาน", style: textLabelStyle,),
                      ...
                      Padding(
                        padding: paddingInputBox,
                        child: Text(
                          itemMain.Destroys.DestroyDepartment, style: textInputStyle,),
                      ),
                    ],
                  ),
                ),
                itemMain.Destroys.Evidences.length>0 ?
                Container(
                  width: size.width,
                  padding: EdgeInsets.only(top: 4.0, bottom: 4.0),
                  child: ListView.builder(
                    physics: NeverScrollableScrollPhysics(),
                    itemCount: itemMain.Destroys.Evidences.length,
                    scrollDirection: Axis.vertical,
                    shrinkWrap: true,
                    itemBuilder: (BuildContext context, int index) {
                      return Container(
