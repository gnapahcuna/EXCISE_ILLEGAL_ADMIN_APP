...
import 'package:prototype_app_pang/main_menu/export/export_book_search_screen.dart';
import 'package:prototype_app_pang/main_menu/export/model/approve.dart';
import 'package:prototype_app_pang/main_menu/export/model/donate.dart';
import 'package:prototype_app_pang/main_menu/export/model/export.dart';
import 'package:prototype_app_pang/main_menu/export/model/export_main.dart';
...
class ExportMainScreenFragment extends StatefulWidget {
  ItemsExportMain ItemsexportMain;
  bool IsUpdate;
  bool IsPreview;
  bool IsCreate;
  ExportMainScreenFragment({
    Key key,
    @required this.ItemsexportMain,
...
class _FragmentState extends State<ExportMainScreenFragment>  with TickerProviderStateMixin {
  ...
  String _currentOfferDate, _currentConsiderDate, _currentDestroyDate,_currentReturnDate,
      _currentOfferTime, _currentConsiderTime, _currentDestroyTime;
  var dateFormatDate, dateFormatTime, _dtOfferDate, _dtConsiderDate,_dtReturnDate,
      _dtDestroyDate;
  ...
  final FocusNode myFocusNodePerson = FocusNode();
  ...
  final FocusNode myFocusNodeExportComment = FocusNode();

  final FocusNode myFocusNodeDonorPerson = FocusNode();
  final FocusNode myFocusNodeDonorPosition = FocusNode();
  final FocusNode myFocusNodeDonorDepartment= FocusNode();
  ...
  TextEditingController editPerson= new TextEditingController();
  TextEditingController editDepartment = new TextEditingController();
  TextEditingController editReturnDate = new TextEditingController();
  TextEditingController editStock = new TextEditingController();
  TextEditingController editExportComment = new TextEditingController();


  TextEditingController editDonorPerson = new TextEditingController();
  TextEditingController editDonorPosition = new TextEditingController();
  TextEditingController editDonorDepartment = new TextEditingController();
  ...
  void initState() {
    ...
    _dtReturnDate = DateTime.now();
    _currentReturnDate = date;


    itemMain = widget.ItemsexportMain;
    if (widget.IsPreview) {
  ...
  void _setDataSaved() {
    ...
    if (choices.length == 2) {
      ...
      //เพิ่ม item forms
      itemsFormsTab.add(
          new ItemsDestroyForms("บันทึกรับมอบของกลางจากคณะกรรมการเก็บรักษาของกลาง (ขก.3)"));
    }
    tabController =
  ...
  void dispose() {
    ...
    editPerson.dispose();
    editDepartment.dispose();
    editReturnDate.dispose();
    ...
    editStock.dispose();
    editExportComment.dispose();

    editDonorPerson.dispose();
    editDonorPosition.dispose();
    editDonorDepartment.dispose();
  ...
  void onSaved() async {
    ...
    setState(() {
      ...
      int exportType;
      ItemsExportApprove approve;
      if(_exportType1){
        exportType=0;
        approve = new ItemsExportApprove(
            editApproveNumber.text,
            editOfferDate.text,
            editOfferTime.text,
            editPerson.text,
            editDepartment.text,
            editPersonConsider.text,
            editConsiderDepartment.text,
            editConsiderDate.text,
            editConsiderTime.text,
            editStock.text,
            editExportComment.text,
            exportType,
            new ItemsGovernment(
              editReturnDate.text,
            ),
        ...
        approve = new ItemsExportApprove(
            ...
            null,
            new ItemsDonate(
                editDonorPerson.text,
                editDonorPosition.text,
                editDonorDepartment.text)
        );
      }

      ItemsExport export= ItemsExport(
          editExportNumber.text,
          editExportDate.text,
          editExportTime.text,
          editExportPerson.text,
          editExportDepartment.text,
          itemEvidence
      );
      itemMain = new ItemsExportMain(approve, export, true);
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> rowContents = <Widget>[
      ...
      Expanded(
          child: Center(child: Text("นำของกลางออกจากคลัง", style: appBarStyle),
          )),
      new SizedBox(
          width: width / 4,
          child: new Row(
  ...
  Widget _buildContent_tab_1() {
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: Text("ประเภทงานคืนของกลาง", style: textLabelStyle,),
                          ),
                          Row(
                                    ...
                                    InkWell(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                          ...
                                          color: _exportType1 ? Color(0xff3b69f3) : Colors
                                              .white,
                                    ...
                                    children: <Widget>[
                                      InkWell(
                                        ...
                                        child: Container(
                                          decoration: BoxDecoration(
                                            shape: BoxShape.circle,
                                            color: _exportType2 ? Color(0xff3b69f3) : Colors
                                                .white,
                                            border: Border.all(color: Colors.black12),
                                          ),
                                          child: Padding(
                          ...
                          Container(
                            ...
                            child: Row(
                              children: <Widget>[
                                Text("ผู้เสนออนุมัติ", style: textLabelStyle,),
                                Text("*", style: textStyleStar,),
                              ],
                            ),
                          ),
                          ...
                          _exportType1?Column(
                            ...
                            children: <Widget>[
                              Container(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    Text("กำหนดคืนวันที่", style: textLabelStyle,),
                                    Text("*", style: textStyleStar,),
                                  ],
                                ),
                              ),
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    Text("พิจารณาวันที่", style: textLabelStyle,),
                                    Text("*", style: textStyleStar,),
                                  ],
                                ),
                              ),
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    Text(
                                      "คลังจัดเก็บ", style: textLabelStyle,),
                                    Text("*", style: textStyleStar,),
                                  ],
                                ),
                              ),
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    Text("เหตุผลในการนำออก", style: textLabelStyle,),
                                    Text("*", style: textStyleStar,),
                                  ],
                                ),
                              ),
                              Padding(
                                padding: paddingInputBox,
                                child: TextField(
                                  focusNode: myFocusNodeExportComment,
                                  controller: editExportComment,
                                  keyboardType: TextInputType.text,
                                  textCapitalization: TextCapitalization.words,
                                  style: textInputStyle,
                                  decoration: InputDecoration(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    Text("เหตุผลในการนำบริจาค", style: textLabelStyle,),
                                    Text("*", style: textStyleStar,),
                                  ],
                                ),
                              ),
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: <Widget>[
                                    Text(
                                      "ผู้รับบริจาค", style: textLabelStyle,),
                                    Text("*", style: textStyleStar,),
                                  ],
                                ),
                              ),
                              Padding(
                                ...
                                child: TextField(
                                  style: textInputStyle,
                                  focusNode: myFocusNodeDonorPerson,
                                  controller: editDonorPerson,
                                  keyboardType: TextInputType.text,
                                  textCapitalization: TextCapitalization.words,
                                  decoration: InputDecoration(
                                    border: InputBorder.none,
                              ...
                              Padding(
                                ...
                                child: TextField(
                                  style: textInputStyle,
                                  focusNode: myFocusNodeDonorPosition,
                                  controller: editDonorPosition,
                                  keyboardType: TextInputType.text,
                                  textCapitalization: TextCapitalization.words,
                                  decoration: InputDecoration(
                                    border: InputBorder.none,
                              ...
                              Padding(
                                ...
                                child: TextField(
                                  style: textInputStyle,
                                  focusNode: myFocusNodeDonorDepartment,
                                  controller: editDonorDepartment,
                                  keyboardType: TextInputType.text,
                                  textCapitalization: TextCapitalization.words,
                                  decoration: InputDecoration(
                                    border: InputBorder.none,
    ...
    Widget _buildContent_saved(BuildContext context) {
      return itemMain.Approves == null ? Container() : Container(
        decoration: BoxDecoration(
            color: Colors.white,
            border: Border(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Container(
                        padding: paddingLabel,
                        child: Text(
                          "ประเภทงานคืนของกลาง", style: textLabelStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
                        child: Text(itemMain.Approves.ExportType==0?"ใช้ทางราชการ":"บริจาค",
                          style: textInputStyle,),
                      ),
                      Container(
                        padding: paddingLabel,
                      ...
                      Padding(
                        padding: paddingInputBox,
                        child: Text(itemMain.Approves.ApproveNumber,
                          style: textInputStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
                      ...
                      Container(
                        padding: paddingLabel,
                        child: Text(itemMain.Approves.OfferDate + " " +
                            itemMain.Approves.OfferTime,
                          style: textInputStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
                        child: Text("ผู้เสนออนุมัติ", style: textLabelStyle,),
                      ),
                      Container(
                        padding: paddingLabel,
                        child: Text(itemMain.Approves.Person,
                          style: textInputStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
                      ...
                      Container(
                        padding: paddingLabel,
                        child: Text(itemMain.Approves.Department,
                          style: textInputStyle,),
                      ),
                      itemMain.Approves.ExportType==0?Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          Padding(
                            padding: paddingInputBox,
                            child: Text("กำหนดคืนวันที่", style: textLabelStyle,),
                          ),
                          Container(
                            padding: paddingLabel,
                            child: Text(itemMain.Approves.Governments.ReturnDate,
                              style: textInputStyle,),
                          ),
                          Container(
                            padding: paddingLabel,
                          ...
                          Padding(
                            padding: paddingInputBox,
                            child: Text(itemMain.Approves.PersonConsider,
                              style: textInputStyle,),
                          ),
                          Container(
                            padding: paddingLabel,
                          ...
                          Padding(
                            padding: paddingInputBox,
                            child: Text(itemMain.Approves.ConsiderDepartment,
                              style: textInputStyle,),
                          ),
                          Padding(
                            padding: paddingInputBox,
                            child: Text("พิจารณาวันที่", style: textLabelStyle,),
                          ),
                          Container(
                            padding: paddingLabel,
                            child: Text(itemMain.Approves.ConsiderDate + " " +
                                itemMain.Approves.ConsiderTime,
                              style: textInputStyle,),
                          ),
                          Container(
                            padding: paddingLabel,
                            child: Text("คลังจัดเก็บ", style: textLabelStyle,),
                          ),
                          Padding(
                            padding: paddingInputBox,
                            child: Text(
                              itemMain.Approves.Stock, style: textInputStyle,),
                          ),
                          Container(
                            padding: paddingLabel,
                          ...
                          Padding(
                            padding: paddingInputBox,
                            child: Text(
                              itemMain.Approves.ExportComment, style: textInputStyle,),
                          ),
                        ],
                      ):Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          ...
                          Container(
                            padding: paddingLabel,
                            child: Text("เหตุผลในการนำบริจาค", style: textLabelStyle,),
                          ),
                          Padding(
                            padding: paddingInputBox,
                            child: Text(
                          ...
                          Container(
                            padding: paddingLabel,
                            child: Text("ผู้รับบริจาค", style: textLabelStyle,),
                          ),
                          Padding(
                            padding: paddingInputBox,
                            child: Text(
                              itemMain.Approves.Donates.DonorPerson, style: textInputStyle,),
                          ),
                          Container(
                            padding: paddingLabel,
                          ...
                          Padding(
                            padding: paddingInputBox,
                            child: Text(
                              itemMain.Approves.Donates.DonorPosition, style: textInputStyle,),
                          ),
                          Container(
                            padding: paddingLabel,
                            child: Text("หน่วยงาน", style: textLabelStyle,),
                          ...
                          Padding(
                            padding: paddingInputBox,
                            child: Text(
                              itemMain.Approves.Donates.DonorDepartment, style: textInputStyle,),
                          ),
                          Container(
                            padding: paddingLabel,
                            child: Text("คลังจัดเก็บ", style: textLabelStyle,),
...
//************************end_tab_1*******************************
  ...
  navigateDeliveredBook(BuildContext context) async {
    final result = await Navigator.push(
      ...
      MaterialPageRoute(
          builder: (context) =>
              ExportBookSearchScreenFragment(
              )),
    );
  ...
  Widget _buildContent_tab_2() {
    Widget _buildExpandableContent(int index) {
      ...
      Widget _buildExpanded(index) {
        itemEvidence[index].EvidenceDetailController.editDeliveredNumber.text =
        "22";
        itemEvidence[index].EvidenceDetailController.editTotalNumber.text =
        "22";
        itemEvidence[index].EvidenceDetailController.editDeliveredVolumn.text =
        "500";
        itemEvidence[index].EvidenceDetailController.editTotalVolumn.text =
        "500";
        itemEvidence[index].EvidenceDetailController.editTotalNumberUnit.text =
        "ขวด";
        itemEvidence[index].EvidenceDetailController.editTotalVolumnUnit.text =
        "ลิตร";
        return Stack(
          children: <Widget>[
            Column(
                ...
                Container(
                  ...
                  child: Text(
                    itemEvidence[index].ProductGroup + ' / ' +
                        itemEvidence[index].MainBrand, style: textInputStyle,),
                ),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Container(
                              padding: paddingLabel,
                              child: Text("จำนวนจำหน่าย", style: textLabelStyle,),
                            ),
                            Padding(
                              padding: paddingInputBox,
                              child: TextField(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      padding: paddingInputBox,
                      child: Text(
                        "Auto Generate", style: textInputStyle,),
                    ),
                    Container(
                      padding: paddingLabel,
                      child: Row(
    ...
    Widget _buildContent_saved(BuildContext context) {
      ...
      Widget _buildExpandableContent(int index) {
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    padding: paddingInputBox,
                    child: Text(
                      itemMain.Exports.Evidences[index].ProductGroup + ' / ' +
                          itemMain.Exports.Evidences[index].MainBrand,
                      style: textInputStyle,),
                  ),
                  SingleChildScrollView(
                    scrollDirection: Axis.horizontal,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                padding: paddingInputBox,
                                child: Text('3', style: textInputStyle,),
                              ),
                            ],
                          ),
                        ),
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                padding: paddingInputBox,
                                child: Text('2', style: textInputStyle,),
                              ),
                            ],
                          ),
                        ),
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                padding: paddingInputBox,
                                child: Text('1', style: textInputStyle,),
                              ),
                            ],
                          ),
                        ),
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                padding: paddingInputBox,
                                child: Text('ขวด', style: textInputStyle,),
                              ),
                            ],
                          ),
                        ),
        ...
        return ExpandableNotifier(
          controller: itemMain.Exports.Evidences[index]
              .EvidenceDetailController
              .expController,
          child: Stack(
            children: <Widget>[
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        padding: paddingInputBox,
                        child: Text(
                          itemMain.Exports.ExportDate + " " +
                              itemMain.Exports.ExportTime,
                          style: textInputStyle,),
                      ),
                      Container(
                        padding: paddingLabel,
                      ...
                      Padding(
                        padding: paddingInputBox,
                        child: Text(
                          itemMain.Exports.ExportDepartment,
                          style: textInputStyle,),
                      ),
                    ],
                  ),
                ),
                itemMain.Exports.Evidences.length > 0 ?
                Container(
                  width: size.width,
                  padding: EdgeInsets.only(top: 4.0, bottom: 4.0),
                  child: ListView.builder(
                    physics: NeverScrollableScrollPhysics(),
                    itemCount: itemMain.Exports.Evidences.length,
                    scrollDirection: Axis.vertical,
                    shrinkWrap: true,
                    itemBuilder: (BuildContext context, int index) {
                      return Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Padding(
                      padding: EdgeInsets.all(8.0),
                      child: new Text(
                        'ILG60_B_10_00_04_00', style: textStylePageName,),
                    )
                  ],
                ),
              ),
