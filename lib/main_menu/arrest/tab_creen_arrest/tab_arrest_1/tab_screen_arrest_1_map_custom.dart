  ...
  void setAutoCompleteProvince(){
    ...
    _textListProvince = new AutoCompleteTextField<ItemsListProvince>(
      ...
      itemBuilder: (context, suggestion) => sProvince==null
          ?new Padding(
          child: new ListTile(
              title: new Text(suggestion.PROVINCE_NAME_TH),),
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: _textListProvince /*DropdownButtonHideUnderline(
                          ...
                          Container(
                            width: size.width,
                            //padding: paddingInputBox,
                            child: _textListDistrict/*DropdownButtonHideUnderline(
                          ...
                          Container(
                            width: size.width,
                            //padding: paddingInputBox,
                            child: _textListSubDistrict/*DropdownButtonHideUnderline(
