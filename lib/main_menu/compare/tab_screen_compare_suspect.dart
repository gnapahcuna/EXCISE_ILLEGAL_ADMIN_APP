...
class TabScreenCompareDeatilSuspect extends StatefulWidget {
  ItemsListArrestPerson ItemsSuspect;
  TabScreenCompareDeatilSuspect({
    Key key,
...
class _FragmentState extends State<TabScreenCompareDeatilSuspect>  with TickerProviderStateMixin {
        ...
        Padding(
          ...
          child: Container(
            ...
            child: ListTile(
              ...
              subtitle: Text(widget.ItemsSuspect.MISTREAT_NO.toString()+' ครั้ง',
                  style: textStyleData),
                ...
                /*child: Row(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: new Text(
                        'ILG60_B_02_00_08_00', style: textStylePageName,),
                    )
                  ],
                ),*/
              ),
