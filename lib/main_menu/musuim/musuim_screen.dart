...
class _FragmentState extends State<MusuimMainScreenFragment>  with TickerProviderStateMixin {
  ...
  void _setDataSaved() {
    ...
    if (choices.length == 2) {
      ...
      //เพิ่ม item forms
      itemsFormsTab.add(
          new ItemsDestroyForms("บัญชีรายการจัดเก็บของกลางเข้าพิพิธภัณฑ์"));
    }
    tabController =
  ...
  void onSaved() async {
    ...
    setState(() {
      ...
      ItemsMusuimApprove approve = new ItemsMusuimApprove(
          editApproveNumber.text,
          editOfferDate.text,
          editOfferTime.text,
          editPersonProponent.text,
          editProponentDepartment.text,
          editPersonConsider.text,
          editConsiderDepartment.text,
          editConsiderDate.text,
          editConsiderTime.text,
          editStock.text);
      ItemsMusuim musuim = ItemsMusuim(
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> rowContents = <Widget>[
      ...
      Expanded(
          child: Center(child: Text("จัดเก็บเข้าพิพิธภัณฑ์", style: appBarStyle),
          )),
      new SizedBox(
          width: width / 4,
          child: new Row(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Row(
                              children: <Widget>[
                                Text("ผู้เสนอพิจารณาเห็นชอบ", style: textLabelStyle,),
                                Text("*", style: textStyleStar,),
                              ],
                            ),
                          ),
                          ...
                          Container(
                            ...
                            child: Row(
                              children: <Widget>[
                                Text(
                                  "ผู้พิจารณาเห็นชอบ", style: textLabelStyle,),
                                Text("*", style: textStyleStar,),
                              ],
                            ),
                          ),
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        padding: paddingInputBox,
                        child: Text("ผู้เสนอพิจารณาเห็นชอบ", style: textLabelStyle,),
                      ),
                      Container(
                        padding: paddingLabel,
                        child: Text(itemMain.Approves.PersonProponent,
                          style: textInputStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
                      ...
                      Container(
                        padding: paddingLabel,
                        child: Text(itemMain.Approves.ProponentDepartment,
                          style: textInputStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
...
//************************end_tab_1*******************************
  ...
  navigateDeliveredBook(BuildContext context) async {
    final result = await Navigator.push(
      ...
      MaterialPageRoute(
          builder: (context) =>
              MusuimBookSearchScreenFragment(
              )),
    );
  ...
  Widget _buildContent_tab_2() {
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Container(
                              padding: paddingLabel,
                              child: Text("จำนวนจัดเก็บ", style: textLabelStyle,),
                            ),
                            Padding(
                              padding: paddingInputBox,
                              child: TextField(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      padding: paddingLabel,
                      child: Text(
                        "เลขที่เก็บเข้าพิพิธภัณฑ์", style: textLabelStyle,),
                    ),
                    Container(
                      padding: paddingInputBox,
                      child: Text(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Text(
                            "ผู้จัดเก็บ", style: textLabelStyle,),
                          Text("*", style: textStyleStar,),
                        ],
                      ),
                    ),
    ...
    Widget _buildContent_saved(BuildContext context) {
      ...
      Widget _buildExpandableContent(int index) {
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    padding: paddingInputBox,
                    child: Text(
                      itemMain.Musuims.Evidences[index].ProductGroup + ' / ' +
                          itemMain.Musuims.Evidences[index].MainBrand,
                      style: textInputStyle,),
                  ),
                  SingleChildScrollView(
                    scrollDirection: Axis.horizontal,
        ...
        return ExpandableNotifier(
          controller: itemMain.Musuims.Evidences[index]
              .EvidenceDetailController
              .expController,
          child: Stack(
            children: <Widget>[
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Container(
                        padding: paddingLabel,
                        child: Text("เลขที่เก็บเข้าพิพิธภัณฑ์", style: textLabelStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
                        child: Text(
                      ...
                      Padding(
                        padding: paddingInputBox,
                        child: Text(
                          itemMain.Musuims.MusuimDate + " " +
                              itemMain.Musuims.MusuimTime,
                          style: textInputStyle,),
                      ),
                      Container(
                        padding: paddingLabel,
