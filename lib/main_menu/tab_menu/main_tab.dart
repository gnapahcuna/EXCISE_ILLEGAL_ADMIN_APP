...
class _MainMenuFragmentFragmentState extends State<MainMenuFragment> {
  ...
  TextStyle Titlestyle = TextStyle(fontSize: 16.0, fontWeight: FontWeight.w500,fontFamily: FontStyles().FontFamily);
  ...
  _getMenuItemWidget(int pos) {
    switch (pos) {
      ...
      case 1:
        return new ArrestFragment(ItemsPerson: widget.ItemsData,itemsTitle: widget.itemsTitle,);
      case 2:
