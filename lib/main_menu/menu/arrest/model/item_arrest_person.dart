...
import 'package:prototype_app_pang/main_menu/menu/arrest/model/item_arrest_person_photo.dart';
  ...
  factory ItemsListArrestPerson.fromJson(Map<String, dynamic> js) {
    return ItemsListArrestPerson(
      LAWBREAKER_ID: js['LAWBREAKER_ID'],
        ...
        MAS_PERSON_PHOTO:List<ItemsListArrestPhotoPerson>.from(js['MAS_PERSON_PHOTO'].map((m) => ItemsListArrestPhotoPerson.fromJson(m))),
        IsCheck: false,
