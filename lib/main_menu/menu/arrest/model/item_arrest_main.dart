...
import 'package:prototype_app_pang/main_menu/menu/arrest/model/item_arrest_indictment.dart';
...
import 'package:prototype_app_pang/main_menu/menu/arrest/model/item_arrest_notice.dart';
...
class ItemsListArrestMain {
  ...
  factory ItemsListArrestMain.fromJson(Map<String, dynamic> js) {
    return ItemsListArrestMain(
      ...
      ArrestProduct: List.from(js['ArrestProduct'].map((m) => ItemsListArrestProduct.fromJson(m))),
