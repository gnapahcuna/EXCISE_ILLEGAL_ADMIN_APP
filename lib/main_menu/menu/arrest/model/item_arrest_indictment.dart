import 'package:prototype_app_pang/main_menu/menu/arrest/model/item_arrest_indictment_detail.dart';
...
class ItemsListArrestIndictment {
  ...
  factory ItemsListArrestIndictment.fromJson(Map<String, dynamic> json) {
    return ItemsListArrestIndictment(
      ...
      ArrestIndictmentDetail:  List.from(json['ArrestIndictmentDetail'].map((m) => ItemsListArrestIndictmentDetail.fromJson(m))),
      ArrestIndictmentProduct:  List.from(json['ArrestIndictmentProduct'].map((m) => ItemsListArrestIndictmentProduct.fromJson(m))),
    );
  }
}