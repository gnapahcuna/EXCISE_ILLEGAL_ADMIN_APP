...
class _TabScreenArrest6SectionState extends State<TabScreenArrest6Section>  {
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Container(
                        ...
                        child: Text(ItemsSuspect[index].TITLE_NAME_TH + ' ' +
                            ItemsSuspect[index].FIRST_NAME+" "+ItemsSuspect[index].LAST_NAME,
                    ...
                    Center(
                        child: InkWell(
                          onTap: () {
                            setState(() {
                              ItemsSuspect[index].IsCheckOffence =
                              !ItemsSuspect[index].IsCheckOffence;
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              shape: BoxShape.rectangle,
                              color: ItemsSuspect[index].IsCheckOffence
                                  ? Color(0xff3b69f3)
                                  : Colors.white,
                              border: ItemsSuspect[index].IsCheckOffence
    ...
    return Container(
      ...
      child: MaterialButton(
        onPressed: () {
          ...
          widget.ItemsSection.ArrestIndictmentDetail = _itemsData;
          _navigateEvidence(context);
        },
        child: Center(
          child: Text(_countItem==0?'ถัดไป':'ถัดไป (${_countItem})', style: textStyleButton,),
        ),
      ),
    );
  }
  ...
  _navigateEvidence(BuildContext context) async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => TabScreenArrest6Evidence(Title: widget.Title,ItemsData: widget.ItemsSection,ItemsProduct: widget.ItemsProduct,)),
    );
        ...
        body: Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              widget.ItemsLawbreaker.length==0?Container()
                  :Container(
