  ...
  Widget _buildSearchResults() {
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        String office_name=_searchResult[index].OPERATION_OFFICE_SHORT_NAME!=null
                        ...
                        child: InkWell(
                          onTap: () {
                            setState(() {
                              ...
                              count==_searchResult.length?isCheckAll=true:isCheckAll=false;
                            });
                          },
                          child: Container(
            ...
            children: <Widget>[
              ...
              _searchResult.length>0?Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Container(
                      child: Text("เลือกผู้ร่วมจับกุมทั้งหมด",
