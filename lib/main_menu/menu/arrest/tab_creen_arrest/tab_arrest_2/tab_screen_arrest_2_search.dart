...
class _TabScreenArrest2SearchState extends State<TabScreenArrest2Search> {
  ...
  TextStyle textExpandStyle = TextStyle(fontSize: 16.0, color: Color(0xff087de1),fontFamily: FontStyles().FontFamily);
  ...
  buildExpandedChecked(index,expandContext) {
   ...
   suspect_name= title+firstname_susp+" "+lastname_susp;
    ...
    String notice_date = "";
    List splits = dateFormatDate.format(DateTime.parse(_searchResult[index].NOTICE_DATE)).toString().split(" ");
