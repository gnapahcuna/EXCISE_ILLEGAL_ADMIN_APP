...
class TabScreenArrest5Edit extends StatefulWidget {
  List<ItemsListArrest5>ItemsData;
  TabScreenArrest5Edit({
    Key key,
    @required this.ItemsData,
  }) : super(key: key);
  @override
  _TabScreenArrest5EditAddState createState() => new _TabScreenArrest5EditAddState();
}
class _TabScreenArrest5EditAddState extends State<TabScreenArrest5Edit>  {
                            ...
                            child: MaterialButton(
                              onPressed: () {
                                widget.ItemsData.forEach((item){
                                  ...
                                  item.PRODUCT_SUBTYPE_NAME = dropdownValueSubSetProductType;
