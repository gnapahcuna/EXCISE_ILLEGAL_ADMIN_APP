...
import 'package:prototype_app_pang/main_menu/menu/arrest/tab_creen_arrest/tab_arrest_4/tab_screen_arrest_4_suspect.dart';
...
class _TabScreenArrest4SearchState extends State<TabScreenArrest4Search> {
  ...
  bool Success=false;
  ItemsListArrestPerson ItemsPreview=null;
  @override
  void initState() {
    super.initState();
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Container(
                        ...
                        child: Text(_itemsInit[index].TITLE_NAME_TH + ' ' +
  ...
  _navigatePreview(BuildContext context,Map map) async {
    ...
    if(Success){
      final result = await Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => TabScreenArrest4Suspect(ItemsSuspect: ItemsPreview,)),
      );
      print(result);
      /*_itemsData=result;
      Navigator.pop(context,_itemsData);*/
