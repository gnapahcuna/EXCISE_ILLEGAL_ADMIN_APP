...
class TransferMainScreenFragment extends StatefulWidget {
  ItemsTransferMain ItemstransferMain;
  bool IsUpdate;
  bool IsPreview;
  bool IsCreate;
  TransferMainScreenFragment({
    Key key,
    @required this.ItemstransferMain,
...
class _FragmentState extends State<TransferMainScreenFragment>  with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    itemMain = widget.ItemstransferMain;
    if (widget.IsPreview) {
  ...
  void _setDataSaved() {
    ...
    if (choices.length == 2) {
      ...
      //เพิ่ม item forms
      itemsFormsTab.add(
          new ItemsDestroyForms("บัญชีรายการโอนย้ายของกลาง"));
    }
    tabController =
  ...
  void onSaved() async {
    ...
    setState(() {
      ...
      ItemsTransApprove approve = new ItemsTransApprove(
          editDeliveredNumber.text,
          editApproveNumber.text,
          editOfferDate.text,
          editOfferTime.text,
          editPersonTransfer.text,
          editDestinationDepartment.text,
          editDestinationStock.text,
          editSourceStock.text,
          editPersonConsider.text,
          editConsiderDepartment.text,
          editConsiderDate.text,
          editConsiderTime.text,
          editCommentTranfer.text);
      ItemsTransfer transfer = ItemsTransfer(
      ...
      itemMain = new ItemsTransferMain(approve, transfer, true);
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Row(
                              children: <Widget>[
                                Text("หน่วยงานปลายทาง", style: textLabelStyle,),
                                Text("*", style: textStyleStar,),
                              ],
                            ),
                          ),
                          Padding(
                            padding: paddingInputBox,
                            child: TextField(
                              focusNode: myFocusNodeDestinationDepartment,
                              controller: editDestinationDepartment,
                              keyboardType: TextInputType.text,
                              textCapitalization: TextCapitalization.words,
                              style: textInputStyle,
                              decoration: InputDecoration(
                          ...
                          Container(
                            ...
                            child: Row(
                              children: <Widget>[
                                Text(
                                  "คลังจัดเก็บต้นทาง", style: textLabelStyle,),
                                Text("*", style: textStyleStar,),
                              ],
                            ),
                          ),
                          Padding(
                            padding: paddingInputBox,
                            child: TextField(
                              focusNode: myFocusNodeSourceStock,
                              controller: editSourceStock,
                              keyboardType: TextInputType.text,
                              textCapitalization: TextCapitalization.words,
                              style: textInputStyle,
                              decoration: InputDecoration(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        padding: paddingInputBox,
                        child: Text(itemMain.Approves.DeliveredNumber,
                          style: textInputStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
                      ...
                      Container(
                        padding: paddingLabel,
                        child: Text(itemMain.Approves.PersonTransfer,
                          style: textInputStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
                      ...
                      Container(
                        padding: paddingLabel,
                        child: Text(itemMain.Approves.SourceStock,
                          style: textInputStyle,),
                      ),
                      Container(
                        padding: paddingLabel,
                      ...
                      Padding(
                        padding: paddingInputBox,
                        child: Text(itemMain.Approves.DestinationStock,
                          style: textInputStyle,),
                      ),
                      Padding(
                        padding: paddingInputBox,
                      ...
                      Padding(
                        padding: paddingInputBox,
                        child: Text(
                          itemMain.Approves.CommentTranfer, style: textInputStyle,),
                      ),
                    ],
                  ),
                ),
...
//************************end_tab_1*******************************
  ...
  navigateDeliveredBook(BuildContext context) async {
    final result = await Navigator.push(
      ...
      MaterialPageRoute(
          builder: (context) =>
              TransferBookSearchScreenFragment(
              )),
    );
  ...
  Widget _buildContent_tab_2() {
    ...
    Widget _buildContent_saved(BuildContext context) {
      ...
      Widget _buildExpandableContent(int index) {
              ...
              Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    padding: paddingInputBox,
                    child: Text(
                      itemMain.Transfers.Evidences[index].ProductGroup + ' / ' +
                          itemMain.Transfers.Evidences[index].MainBrand,
                      style: textInputStyle,),
                  ),
                  SingleChildScrollView(
                    child: Row(
        ...
        return ExpandableNotifier(
          controller: itemMain.Transfers.Evidences[index]
              .EvidenceDetailController
              .expController,
          child: Stack(
            children: <Widget>[
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        padding: paddingInputBox,
                        child: Text(
                          itemMain.Transfers.TransferNumber,
                          style: textInputStyle,),
                      ),
                      Container(
                        padding: paddingLabel,
                      ...
                      Padding(
                        padding: paddingInputBox,
                        child: Text(
                          itemMain.Transfers.TransferDate + " " +
                              itemMain.Transfers.TransferTime,
                          style: textInputStyle,),
                      ),
                      Container(
                        padding: paddingLabel,
                      ...
                      Padding(
                        padding: paddingInputBox,
                        child: Text(
                          itemMain.Transfers.TransferPerson,
                          style: textInputStyle,),
                      ),
                      Container(
                        padding: paddingLabel,
                      ...
                      Padding(
                        padding: paddingInputBox,
                        child: Text(
                          itemMain.Transfers.TransferDepartment,
                          style: textInputStyle,),
                      ),
                    ],
                  ),
                ),
                itemMain.Transfers.Evidences.length > 0 ?
                Container(
                  width: size.width,
                  padding: EdgeInsets.only(top: 4.0, bottom: 4.0),
                  child: ListView.builder(
                    physics: NeverScrollableScrollPhysics(),
                    itemCount: itemMain.Transfers.Evidences.length,
                    scrollDirection: Axis.vertical,
                    shrinkWrap: true,
                    itemBuilder: (BuildContext context, int index) {
                      return Container(
