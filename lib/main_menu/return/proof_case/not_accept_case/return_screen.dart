...
class _FragmentState extends State<ReturnMainScreenFragment>
  ...
  String _currentOfferDate,
      _currentConsiderDate,
      _currentDestroyDate,
      _currentReturnDate,
      _currentOfferTime,
      _currentConsiderTime,
      _currentDestroyTime;
  var dateFormatDate,
      dateFormatTime,
      _dtOfferDate,
  ...
  final FocusNode myFocusNodeVatBook = FocusNode();
  final FocusNode myFocusNodeVatNum = FocusNode();
  ...
  TextEditingController editVatNum = new TextEditingController();
  TextEditingController editVatBook = new TextEditingController();
  ...
  final FocusNode myFocusNodeExportTimeIn = FocusNode();
  TextEditingController editExportTimeIn = new TextEditingController();
  ...
  TextStyle textStylePageName = TextStyle(
      ...
      fontFamily: FontStyles().FontFamily);
  TextStyle textStyleStar =
      TextStyle(color: Colors.red, fontFamily: FontStyles().FontFamily);
  TextStyle textLabelEditNonCheckStyle =
  ...
  void _setDataSaved() {
    ...
    if (choices.length == 2) {
      ...
      //เพิ่ม item forms
      itemsFormsTab.add(new ItemsDestroyForms(
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                ...
                child: Text(
                  "ยืนยันการลบข้อมูลทั้งหมด",textAlign: TextAlign.center,
    ...
    setState(() {
      ...
      if (_exportType1) {
        ...
        approve = new ItemsExportApprove(
            ...
            exportType,
            null,
            new ItemsDonate(editDonorPerson.text, editDonorPosition.text,
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle appBarStyle = TextStyle(
        ...
        color: Colors.white,
        fontFamily: FontStyles().FontFamily);
    TextStyle appBarStylePay = TextStyle(
        fontSize: 16.0,
        color: Colors.white,
        fontFamily: FontStyles().FontFamily);
                              ...
                              ? Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Padding(
                                      ...
                                      child: TextField(
                                        style: textInputStyle,
                                        focusNode: myFocusNodeVatNum,
                                        controller: editVatNum,
                                    ...
                                    Padding(
                                      ...
                                      child: TextField(
                                        style: textInputStyle,
                                        focusNode: myFocusNodeVatBook,
                                        controller: editVatBook,
                                        keyboardType: TextInputType.text,
                                        textCapitalization:
                                            TextCapitalization.words,
                                        decoration: InputDecoration(
                                    ...
                                    Padding(
                                      padding: paddingInputBox,
                                      child: TextField(
                                        focusNode: myFocusNodeExportTimeIn,
                                        controller: editExportTimeIn,
                                        keyboardType: TextInputType.text,
                                        textCapitalization:
                                            TextCapitalization.words,
                                        style: textInputStyle,
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              padding: paddingInputBox,
                              child: Text(
                                itemMain.Approves.ExportType == 0
                                    ? "คืนของกลางภายใน"
                                    : "คืนของกลางภายนอก",
                                style: textInputStyle,
                              ),
                                ...
                                ? Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          itemMain
                                              .Approves.Governments.ReturnDate,
                                          style: textInputStyle,
                                        ),
                                      ),
                                      Container(
                                      ...
                                      Container(
                                        padding: paddingLabel,
                                        child: Text(
                                          itemMain.Approves.ConsiderDate +
                                              " " +
                                      ...
                                      Padding(
                                        padding: paddingInputBox,
                                        child: Text(
                                          itemMain.Approves.ExportComment,
                                          style: textInputStyle,
                                        ),
                                      ),
                                    ],
                                ...
                                : Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        padding: paddingInputBox,
                                        child: Text(
                                          itemMain.Approves.Donates.DonorPerson,
                                          style: textInputStyle,
                                        ),
                                      ),
                                      Container(
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          itemMain
                                              .Approves.Donates.DonorPosition,
                                          style: textInputStyle,
                                        ),
                                      ),
                                      Container(
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          itemMain
                                              .Approves.Donates.DonorDepartment,
                                          style: textInputStyle,
                                        ),
                                      ),
                                      Container(
...
//************************end_tab_1*******************************
        ...
        children: <Widget>[
          new Card(
              shape: new RoundedRectangleBorder(
                  side: new BorderSide(color: boxColor, width: 1.5),
  ...
  navigateDeliveredBook(BuildContext context) async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => ReturnBookSearchScreenFragment()),
    );
  ...
  Widget _buildContent_tab_2() {
    ...
    Widget _buildContent_saved(BuildContext context) {
      ...
      Widget _buildExpandableContent(int index) {
        ...
        return ExpandableNotifier(
          controller: itemMain
              .Exports.Evidences[index].EvidenceDetailController.expController,
          child: Stack(
            children: <Widget>[
              Expandable(
                  collapsed: _buildCollapsed(index),
