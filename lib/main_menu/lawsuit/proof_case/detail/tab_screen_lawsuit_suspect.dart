...
class TabScreenLawsuitDeatilSuspect extends StatefulWidget {
  ItemsListArrestPerson ItemsSuspect;
  TabScreenLawsuitDeatilSuspect({
    Key key,
...
class _FragmentState extends State<TabScreenLawsuitDeatilSuspect>  with TickerProviderStateMixin {
