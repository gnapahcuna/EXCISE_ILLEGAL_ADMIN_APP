...
class LawsuitNotAcceptSuspectScreenFragment extends StatefulWidget {
...
class _FragmentState extends State<LawsuitNotAcceptSuspectScreenFragment>  with TickerProviderStateMixin {
              ...
              onTap: (){
                Navigator.of(context)
                    ...
                    new MaterialPageRoute(
                        builder: (context) => LawsuitNotAcceptOffenseListScreenFragment(ItemsOffense: widget.ItemsSuspect.Offenses)));
              },
